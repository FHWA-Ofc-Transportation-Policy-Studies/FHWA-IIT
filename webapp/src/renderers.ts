...
//#region EQUITY RENDERERS (counties)
...
export let noiseEquityRendererNonWhite = new SimpleRenderer({
    symbol: equityDottedLineSymbol as __esri.SymbolProperties,
    visualVariables: [
        {
            type: 'color',
            field: 'nonwhite_e',
...
export let acsRendererNonWhite = new SimpleRenderer({
    // type: 'simple',
    symbol: { type: 'simple-fill', outline: acsSimpleLineSymbol } as __esri.SymbolProperties,
    visualVariables: [
        {
            type: 'color',
            field: 'nonwhite__',
...
//#region MISCELLENEOUS RENDERERS
