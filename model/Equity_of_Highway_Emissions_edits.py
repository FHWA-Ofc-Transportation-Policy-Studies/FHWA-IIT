...
house_value = pandas.read_csv(os.path.join(root_input,"State_median_housing values.csv"))
...
def equity(c):
    ...
    for i in indexes_replace:
        road['population'][i] = {'0-17':0,'18-24':0,'25-34':0,'35-44':0,'45-54':0,'55-64':0,'65-74':0,'75-84':0,'85+':0}
    ta = time()
